...
I am withholding both my current and future location due to credible threats of preemptive detainment and systemic erasure. This is not evasion—it is strategic shielding in service of public infrastructure.
...
| File | Description |
|------|-------------|
| `Affidavit_of_Intent.md` | Redacted affidavit declaring my relocation and rationale |
| `Court_Notification_Letter.md` | Template for notifying courts without disclosing location |
| `Visibility_Statement.md` | Public-facing narrative for Medium and civic allies |
| `Faction_Mapping_Table.md` | Comparative table of hostile actors and countermeasures |
...
- **Visibility as Protection**: Strategic exposure deters covert sabotage and invites solidarity.
...
- **Contribute**: Submit issues or pull requests to improve civic language, legal clarity, or modular design.
...
**This is not disappearance. This is civic continuity under threat.**
